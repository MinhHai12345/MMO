...
public interface MatchPredictionRepository extends JpaRepository<MatchPrediction, Long> {
    ...
    List<MatchPrediction> findByStatusAndKickoffTimeBetweenOrderByKickoffTimeAsc(MatchPredictionStatus status,
                                                                                 LocalDateTime start, LocalDateTime end);

    List<MatchPrediction> findByStatusInAndKickoffTimeBetweenOrderByKickoffTimeAsc(Collection<MatchPredictionStatus> statuses,
                                                                                   LocalDateTime start, LocalDateTime end);
}
